    ...
    with env.begin(write=True) as txn:
        ...
        for i, fn in enumerate(fns):
            ...
            for j in range(N):
                ...
                txn.put(str_id.encode('ascii'), data_byte)#添加数据和键值
...
def create_icvl64_31():
    ...
    datadir = '/home/wuzhehui/Hyper_CS/SSDM-main/data/ICVL/Training/' # your own data address
    fns = os.listdir(datadir)
    fns = [fn.split('.')[0]+'.mat' for fn in fns]
    
    create_lmdb_train(
        datadir, fns, '/home/wuzhehui/Hyper_CS/SSDM-main/data/dataset/ICVL/Training/ICVL64_31', 'rad',  # your own dataset address
...
def create_icvl128_31():
    ...
    create_lmdb_train(
        datadir, fns, '/home/wuzhehui/Hyper_CS/SSDM-main/data/dataset/ICVL/Training/ICVL128_31', 'rad',  # your own dataset address
        crop_sizes=(1024, 1024),
        scales=(1, 0.5, 0.25),        
        ksizes=(31, 128, 128),
...
def create_icvl256_31():
    ...
    create_lmdb_train(
        datadir, fns, '/home/wuzhehui/Hyper_CS/SSDM-main/data/dataset/ICVL/Training/ICVL256_31', 'rad',  # your own dataset address
        crop_sizes=(1024, 1024),
        scales=(1, 0.5, 0.25),        
        ksizes=(31, 256, 256),
...
def createApex():
    print('create apex...')
    datadir = '/home/wuzhehui/Hyper_CS/SSDM-main/data/APEX/Training/'
    
    fns = os.listdir(datadir) 
    create_lmdb_train(
        datadir, fns, '/home/wuzhehui/Hyper_CS/SSDM-main/data/dataset/APEX/Training/APEX64_210', 'data',  # your own dataset address
        crop_sizes=None,
